...
namespace Microsoft.AspNetCore.Mvc
{
    ...
    public abstract class ControllerBase
    {
        ...
        /// <returns>The created <see cref="BadRequestObjectResult"/> for the response.</returns>
        [NonAction]
        public virtual BadRequestObjectResult ValidationProblem(ValidationProblemDescriptor descriptor)
        {
            if (descriptor == null)
            {
        ...
        public virtual BadRequestObjectResult ValidationProblem(ModelStateDictionary modelStateDictionary)
        {
            ...
            var validationProblem = new ValidationProblemDescriptor(modelStateDictionary);
        ...
        {
            var validationProblem = new ValidationProblemDescriptor(ModelState);
            return new BadRequestObjectResult(validationProblem);
        }
